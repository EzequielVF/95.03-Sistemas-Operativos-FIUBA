...
extern void trap_div_zero(void);
extern void trap_debug(void);
extern void trap_nmi(void);
extern void trap_breakpt(void);
extern void trap_overflow(void);
extern void trap_bound(void);
extern void trap_invalid_opcode(void);
extern void trap_device_not_av(void);
extern void trap_double_fault(void);
extern void trap_invalid_tts(void);
extern void trap_segment_not_present(void);
extern void trap_stack_segment_fault(void);
extern void trap_general_protection(void);
extern void trap_page_fault(void);
extern void trap_float_point_error(void);
extern void trap_alignment_check(void);
extern void trap_machine_check(void);
extern void trap_float_point_excep(void);
extern void trap_syscall(void);
extern void trap_timer(void);
extern void trap_kbd(void);
...
trap_init(void)
{
	...
	SETGATE(idt[T_BRKPT], 0, GD_KT, &trap_breakpt, 3);
	...
	SETGATE(idt[T_DEVICE], 0, GD_KT, &trap_device_not_av, 0);
	SETGATE(idt[T_DBLFLT], 0, GD_KT, &trap_double_fault, 0);
	SETGATE(idt[T_TSS], 0, GD_KT, &trap_invalid_tts, 0);
	...
	SETGATE(idt[T_FPERR], 0, GD_KT, &trap_float_point_error, 0);
	SETGATE(idt[T_ALIGN], 0, GD_KT, &trap_alignment_check, 0);
	SETGATE(idt[T_MCHK], 0, GD_KT, &trap_machine_check, 0);
	SETGATE(idt[T_SIMDERR], 0, GD_KT, &trap_float_point_excep, 0);
	SETGATE(idt[T_SYSCALL], 0, GD_KT, &trap_syscall, 3);
	SETGATE(idt[IRQ_OFFSET + IRQ_TIMER], 0, GD_KT, &trap_timer, 3);
	SETGATE(idt[IRQ_OFFSET + IRQ_KBD], 0, GD_KT, &trap_kbd, 3);
	SETGATE(idt[IRQ_OFFSET + IRQ_SERIAL], 0, GD_KT, &trap_serial, 3);
...
page_fault_handler(struct Trapframe *tf)
{
	...
	if (curenv->env_pgfault_upcall) {
		...
		user_mem_assert(curenv, top - size, size, PTE_U | PTE_P | PTE_W);
