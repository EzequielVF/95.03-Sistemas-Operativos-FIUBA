...
serve_read(envid_t envid, union Fsipc *ipc)
{
	...
	size_t bytes = (req->req_n > PGSIZE) ? PGSIZE : req->req_n;
	if ((r = file_read(o->o_file, ret->ret_buf, bytes, o->o_fd->fd_offset)) < 0)
		return r;
...
serve_write(envid_t envid, struct Fsreq_write *req)
{
	...
	if (o->o_file->f_size <= o->o_fd->fd_offset + r)
		file_set_size(o->o_file, o->o_fd->fd_offset + r);
	o->o_fd->fd_offset += r;
